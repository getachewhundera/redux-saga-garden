...
Create a new database called `garden` and run the SQL in the `database.sql` file. //DONE
...
1. Add the `redux-logger` middleware to the project for debugging.    npm install redux-saga//DONE 
